...
public abstract class TuioContainer:TuioPoint {
	 ...
	 */ 
	public static readonly int TUIO_ACCELERATING = 1;
	/**
	 * Defines the DECELERATING state.
	 */ 
	public static readonly int TUIO_DECELERATING = 2;
	/**
	 * Defines the STOPPED state.
	 */ 
	public static readonly int TUIO_STOPPED = 3;
	/**
	 * Defines the REMOVED state.
	 */ 
	public static readonly int TUIO_REMOVED = 4;
	/**
